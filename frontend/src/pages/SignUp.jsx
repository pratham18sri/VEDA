    ...
    <div className='w-full min-h-screen bg-black flex items-center justify-center p-4 sm:p-6 relative overflow-hidden'>
      ...
      >
        ...
        <div className="flex justify-center items-center mb-4">
          ...
          <span className="text-purple-300 font-mono ml-4 text-sm">SWITCH_TO_LOGIN</span>
        </div>

        {/* Typing animation */}
        <div className="text-center mb-4">
          <TextType 
            text={["WELCOME_TO_VEDA_NETWORK", "AUTHENTICATION_REQUIRED", "PLEASE_ENTER_CREDENTIALS"]}
            typingSpeed={50}
            pauseDuration={1000}
            showCursor={true}
            cursorCharacter="_"
            className="text-purple-400 text-lg sm:text-xl font-mono"
          />
        </div>
        ...
        <CyberInput>
          <div className="cyber-input-group">
            <input 
              ...
              value={name}
            />
            <label className="cyber-label">USER_NAME</label>
          </div>
